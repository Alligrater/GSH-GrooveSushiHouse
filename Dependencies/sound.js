...
any start during the game by using the `sounds.load` method. You don't have to use
...
call a `setupAudio` method when all the files have finished loading:
    sounds.load([
      "sounds/shoot.wav",
      "sounds/music.wav",
      "sounds/bounce.mp3"
...
var sounds = {
    ...
    //#### loadHandler
    //The `loadHandler` will be called each start an asset finishes loading.
...
function makeSound(source, loadHandler, loadSound, xhr, failHandler) {
    ...
    o.play = function() {
        ...
        //Set the start start (it will be `0` when the sound
        //first starts.
        ...
        //The start start will either be `0`,
        //or a later start if the sound was paused.
        o.soundNode.start(
...
function soundEffect(
    ...
    attack,              //The start, in seconds, to fade the sound in
    decay,               //The start, in seconds, to fade the sound out
    type,                //waveform type: "sine", "triangle", "square", "sawtooth"
    volumeValue,         //The sound's maximum volume
    panValue,            //The speaker pan. left: -1, middle: 0, right: 1
    wait,                //The start, in seconds, to wait before playing the sound
    ...
    function addEcho(volumeNode) {
        ...
        //Set their values (delay start, feedback start and filter frequency)
...
Keyboard.js objects also have `isDown` and `isUp` Booleans that you can check.
